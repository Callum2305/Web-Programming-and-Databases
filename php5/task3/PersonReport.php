...
<input type = 'button' id = "emailButton" value = 'Email Address Order' onclick = 'emailOrder()' title = 'Click here to see Persons in alphabetical order of email'>
<br>
<br>

<!--Create functions that set a value based off what button is clicked-->
<script>
...
<?php
//Disable buttons based off choice. Disable the button of the choice already selected. Default is Surname.
...
//If you selected DOB, disable button for DOB and enable button for email and surname
if ($choice == "DOB")
{
?>
    <script>
...
else if ($choice == "Surname")//if ($choice == "surname") or the default display before any button is clicked
{
?>
    <script>
