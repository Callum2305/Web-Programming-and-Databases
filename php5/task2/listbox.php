...
// Catherine had deleted flag = 2 as where clause, but we dont have that in the tabel? so i added it to the persons table and set default to 0
//now including email and phone for task2
